                    ...
                    <ul>
                        <li>
                            <div class="input-append newsletter-box text-center">
                                <form class="form-group" method="POST" id="subscribeForm">
                                    <input class="form-control" type="text" class="full text-center" name="subscribeEmail" placeholder="<?= lang('email_address') ?>">
                                    <button class="form-control btn-blue" onclick="checkEmailField()" type="button"> <?= lang('subscribe') ?> <i class="fa fa-long-arrow-right"></i></button>
                                </form>
                            </div>
                        </li>
                    </ul>
