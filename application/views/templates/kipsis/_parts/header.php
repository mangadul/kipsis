    ...
    <body>
        <div id="wrapper">
            ...
            <!--
                ...
                <nav class="navbar transparent gradient-color navbar-fixed-top">
                    <div class="container">
                            ...
                            ?>
                                ...
                                foreach ($allLanguages as $key_lang => $lang) {
                                    ...
                                    <a href="<?= base_url($key_lang) ?>"> 
                                        <img src="<?= base_url('attachments/lang_flags/' . $lang['flag']) ?>" alt="Language-<?= MY_LANGUAGE_ABBR ?>"> <?= $lang['name'] ?></a>
                                    </li>
                                    <?php
                                    $i++;
                                }
